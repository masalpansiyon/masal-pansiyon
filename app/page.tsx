...
// import { HOTEL_INFO, ROOMS } from './constant/data';
// import { Phone, CheckCircle2, BedDouble, Wifi, MapPin } from 'lucide-react'; // İkonlar için (npm install lucide-react)
...
//             </a>
//             <a href={`tel:${HOTEL_INFO.phone}`} className="w-full sm:w-auto bg-white/10 hover:bg-white/20 text-white border border-white/30 backdrop-blur-md px-12 py-5 rounded-2xl font-bold text-lg transition-all flex items-center justify-center gap-3">
...
//           {ROOMS.map((room) => (
//             <div key={room.id} className="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-500">
//               <div className="relative h-72 overflow-hidden">
//                 <img src={room.image} alt={room.name} className="w-full h-full object-cover group-hover:scale-110 transition duration-700" />
...
//               <div className="p-8">
//                 <h3 className="text-2xl font-bold text-slate-900 mb-3">{room.name}</h3>
...
//                   </div>
//                   <a href={`tel:${HOTEL_INFO.phone}`} className="bg-slate-900 text-white px-6 py-3 rounded-xl font-bold hover:bg-amber-600 transition-colors shadow-lg">
//                     Bilgi Al
//                   </a>
//                 </div>
//               </div>
...
// import { client } from '../sanity/lib/client'; // Sanity istemci yolunu kontrol et
...
//     features
//   }`;
//   const data = await client.fetch(query, {}, { next: { revalidate: 10 } }); // 10 saniyede bir veriyi tazeler
//   return data;
// }

// export default async function Home() {
//   const ROOMS = await getRooms(); // Canlı veriyi çekiyoruz
...
//       {/* --- ODALAR VE FİYATLAR (Sanity Entegrasyonu) --- */}
//       <section id="odalar" className="py-24 bg-slate-50">
//         <div className="max-w-7xl mx-auto px-6 text-center mb-16">
//           <h2 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mb-4 tracking-tight">Oda Seçeneklerimiz</h2>
//           <div className="h-1.5 w-24 bg-amber-600 mx-auto rounded-full mb-6"></div>
...
//         <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 lg:grid-cols-3 gap-10">
//           {ROOMS?.map((room: any) => (
//             <div key={room._id} className="group bg-white rounded-[2.5rem] overflow-hidden shadow-sm border border-slate-100 hover:shadow-2xl transition-all duration-500">
//               <div className="relative h-72 overflow-hidden">
...
// // Sanity'den odaları çeken fonksiyon - slug alanını ekledik
// async function getRooms() {
//   const query = `*[_type == "room"]{
//     _id,
//     title,
...
//     "image": image.asset->url,
//     features,
//     slug // Detay sayfası için gerekli
//   }`;
...
const HOTEL_PHONE = "+90 5XX XXX XX XX"; 
